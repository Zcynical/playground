...
let INPUTS: {[name: string]: InputFeature} = {
  "x": {f: (x, y) => x, label: "X_1"},
  "y": {f: (x, y) => y, label: "X_2"},
  "sinPX": {f: (x, y) => Math.sin(x*3.1415926), label: "sin(piX_1)"},
  "cosPX": {f: (x, y) => Math.cos(x*3.1415926), label: "cos(piX_1)"},
  "sinPY": {f: (x, y) => Math.sin(y*3.1415926), label: "sin(piX_2)"},
  "cosPY": {f: (x, y) => Math.cos(y*3.1415926), label: "cos(piX_2)"},
  "sin2PX": {f: (x, y) => Math.sin(x*2*3.1415926), label: "sin(2piX_1)"},
  "cos2PX": {f: (x, y) => Math.cos(x*2*3.1415926), label: "cos(2piX_1)"},
  "sin2PY": {f: (x, y) => Math.sin(y*2*3.1415926), label: "sin(2piX_2)"},
  "cos2PY": {f: (x, y) => Math.cos(y*2*3.1415926), label: "cos(2piX_2)"},
};
